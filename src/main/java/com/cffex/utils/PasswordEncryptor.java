...
public class PasswordEncryptor {
    ...
    public PasswordEncryptor(Object salt) {
        this(salt,"sha-256");
    }
    ...
    public static void main(String[] args) {
        ...
        System.out.println("encrypted pass" + encodedPassword + "\npassword length" + encodedPassword.length());
        System.out.println("salt:" + salt);
        boolean valid=encoderMd5.isPasswordValid(encodedPassword,"xiaochangwei's password");
